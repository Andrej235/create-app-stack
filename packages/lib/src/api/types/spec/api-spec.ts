export type ApiSpec={
  ...
  "paths": {
      ...
      "patch": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/UpdateTeamInfoRequestDto"
              }
            },
            "text/json": {
              "schema": {
      ...
      "patch": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/UpdateTeamLogoRequestDto"
              }
            },
            "text/json": {
              "schema": {
    ...
    "/prospects/{teamId}/{prospectId}/partial": {
      "get": {
        "tags": [
          "Prospect"
        ],
      ...
      "patch": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/ArchiveProspectsRequestDto"
              }
            },
            "text/json": {
              "schema": {
    ...
    "/cold-outreach-email-templates": {
      "post": {
        "tags": [
          "ColdOutreachEmailTemplate"
        ],
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/CreateColdOutreachEmailTemplateRequestDto"
              }
            },
            "text/json": {
              "schema": {
        ...
        "responses": {
          ...
          "201": {
            ...
            "content": {
              "text/plain": {
                "schema": {
                  "$ref": "#/components/schemas/ColdOutreachEmailTemplateResponseDto"
                }
              },
              "application/json": {
                "schema": {
      ...
      "put": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/UpdateColdOutreachEmailTemplateRequestDto"
              }
            },
            "text/json": {
              "schema": {
    ...
    "/cold-outreach-email-templates/{teamId}/{id}": {
      "delete": {
        "tags": [
          "ColdOutreachEmailTemplate"
        ],
        ...
        "responses": {
          ...
          "200": {
            ...
            "content": {
              "text/plain": {
                "schema": {
                  "$ref": "#/components/schemas/FullColdOutreachEmailTemplateResponseDto"
                }
              },
              "application/json": {
                "schema": {
    ...
    "/cold-outreach-email-templates/{teamId}": {
      "get": {
        "tags": [
          "ColdOutreachEmailTemplate"
        ],
      ...
      "post": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/GenerateColdOutreachEmailRequestDto"
              }
            },
            "text/json": {
              "schema": {
        ...
        "x-stream": {
          "role": "producer",
          "key": "cold-outreach-email",
          "consumers": [
            {
              "path": "/cold-outreach-emails/stream-job/{jobId}",
              "method": "get"
            }
          ]
        }
    ...
    "/cold-outreach-emails/stream-job/{jobId}": {
      "get": {
        "tags": [
          "ColdOutreachEmail"
        ],
        ...
        "x-stream": {
          ...
          "producers": [
            {
              "path": "/cold-outreach-emails/generate",
              "method": "post"
            }
          ]
        }
  ...
  "components": {
    "schemas": {
      ...
      "ColdOutreachEmailTemplateResponseDto": {
        "type": "object",
        "properties": {
          "id": {
            "type": "string",
      ...
      "CreateColdOutreachEmailTemplateRequestDto": {
        "type": "object",
        "properties": {
          "name": {
            "type": "string"
      ...
      "CreateEmailTemplateRequestDto": {
        ...
        "properties": {
          "subjectType": {
            "$ref": "#/components/schemas/EmailTemplateSubjectType"
          },
          "staticSubject": {
            "type": "string",
            "nullable": true
      ...
      "FullColdOutreachEmailTemplateResponseDto": {
        "type": "object",
        "properties": {
          "id": {
            "type": "string",
      ...
      "GenerateColdOutreachEmailRequestDto": {
        "type": "object",
        "properties": {
          "prospectId": {
            "type": "string",
      ...
      "UpdateColdOutreachEmailTemplateRequestDto": {
        "type": "object",
        "properties": {
          "id": {
            "type": "string",
  ...
  "tags": [
    ...
    {
      "name": "ColdOutreachEmailTemplate"
    },
    {
      "name": "ColdOutreachEmail"
    }
  ]
}
